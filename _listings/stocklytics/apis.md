...
created: "2018-08-23"
modified: "2018-08-23"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/historical-data/master/_listings/stocklytics/apis.md
...
- name: Stocklytics Company Data API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/historical-data/master/_listings/stocklytics/openapi.md
- name: Stocklytics Historical Stock Prices API
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/historical-data/master/_listings/stocklytics/historicalpricesapi-version-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/historical-data/master/_listings/stocklytics/historicalpricesapi-version-get-openapi.md
- name: Stocklytics Historical Stock Prices API
  x-api-slug: stocklytics-historical-stock-prices-api
  description: Build feature rich, fast applications and websites based around accurate
    stock market data. Launch in hours rather than days using the Stocklytics API.
